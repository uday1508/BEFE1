import axios from "axios";
 ...
 const API_BASE_URL = "https://backendtask1-1ut1.onrender.com/api";
...
// api for updating logouttime
export const logoutUser = async ({email}) => {
  try {
    console.log(email,"THIS IS EMAIL");
     const { data } = await axios.post(`${API_BASE_URL}/users/logout`,{"email":email});
     return data;
  } catch (error) {
